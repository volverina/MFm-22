...
var cube, lightTwo, torus, renderer = false, scene, camera, controls;

document.getElementById('start').addEventListener("click", start);

function start()
{
	const field = document.getElementById( 'what' );
	...
	if(document.getElementById( 'FirstPersonControls' ).checked)
	{
...
//	camera.rotation.y += phi/100;
	if(document.getElementById( 'OrbitControls' ).checked)
		controls.update();
	if(document.getElementById( 'FirstPersonControls' ).checked || document.getElementById( 'FlyControls' ).checked)
